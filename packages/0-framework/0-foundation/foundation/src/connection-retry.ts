/**
 * Connection-resilience helpers for Postgres cold-starts (FT-5226): a
 * transient-error predicate and a bounded retry. Pure — no driver, no heavy
 * imports — so both deploy-time lowerings and bun-runnable services can use one
 * implementation.
 */
