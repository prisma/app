 ...
 * the deploy VM at runtime and must never be bundled. Verified
 * (`@prisma/compose/node/control` sets
 * `external: ['bun']` ahead of `noExternal` in its tsdown call, and tsdown/
