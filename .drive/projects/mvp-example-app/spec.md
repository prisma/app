...
Prove that Prisma Composer's model can be provisioned and deployed to
...
- **Prisma Composer primitives.** This project builds *directly* on Alchemy.
...
Builds on the settled Prisma Composer design in
...
- [`docs/design/`](../../../docs/design/) — the settled Prisma Composer model.
