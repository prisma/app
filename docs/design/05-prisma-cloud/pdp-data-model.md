# PDP data model — as it pertains to Prisma Composer
...
Prisma Composer touches — compute, config, databases; billing/auth/SCM
omitted.
...
Consequences Prisma Composer designs around:
...
- [`../03-domain-model/layering.md`](../03-domain-model/layering.md) — where the
  hosting plane sits in Prisma Composer's three-plane picture.
