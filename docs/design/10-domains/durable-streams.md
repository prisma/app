...
Define the Durable Streams model as the primary communication and data access primitive for MakerKit and the Prisma Platform.
...
- `docs/design/10-domains/makerkit-overview.md` (Durable Streams backbone section)
