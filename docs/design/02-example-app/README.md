...
the Sales Service's environment. The framework emits the whole graph as the
topology artifact — Configuration and egress ride along as environment binding,
not nodes.
