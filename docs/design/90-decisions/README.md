...
- [ADR-0033](ADR-0033-composer-rpc-adopts-native-orpc-v2-contracts-and-runtime.md) — Composer adopts native oRPC v2 contracts, routers, and runtime while retaining topology, dependency hydration, exact contract identity, per-edge authorization, mount policy, and request limits.
