...
- [ADR-0026](ADR-0026-name-the-framework-prisma-composer.md) — The framework is **Prisma Composer**; "Prisma App" names only the artifact you build. Supersedes ADR-0014's framework, package, and CLI names: `@prisma/composer*` (incl. `compose-alchemy`), `prisma-composer`, `prisma-composer.config.ts`.
