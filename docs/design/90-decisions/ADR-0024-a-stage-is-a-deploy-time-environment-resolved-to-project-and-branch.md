...
```sh
prisma-composer deploy module.ts                  # the production environment
...
```
prisma-composer deploy module.ts --stage staging
│
...
- **The default stage is the Project level.** No Branch is created and no
  ...
  ([ADR-0033](ADR-0033-deploy-state-lives-in-the-stage-branch.md)), read-only.
...
- [ADR-0033](ADR-0033-deploy-state-lives-in-the-stage-branch.md) — the
