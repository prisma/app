...
The intent is to keep "how Cloudflare works" relatively static here, while keeping "what Prisma Composer should do because of it" in a separate takeaways doc that we can revise as our own design evolves.
...
- `takeaways-for-prisma-composer.md`: what we want to emulate/adapt in Prisma Composer (expected to change)
