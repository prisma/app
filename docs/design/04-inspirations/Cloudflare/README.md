...
The intent is to keep "how Cloudflare works" relatively static here, while keeping "what the Prisma App Framework should do because of it" in a separate takeaways doc that we can revise as our own design evolves.
