...
The intent is to keep “how TanStack works” relatively static here, while keeping “what Prisma Composer should do because of it” in a separate takeaways doc that we can revise as our own design evolves.
