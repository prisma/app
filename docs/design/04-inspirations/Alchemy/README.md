...
Prisma Composer does: resources + executables defined in code, dependency injection
...
2. **Viability study** — whether Prisma Composer should adopt Alchemy instead of being built.

## Read this first

- **[viability-assessment.md](viability-assessment.md)** — the answer to "use
  Alchemy instead of building Prisma Composer?", with the reasoning.
...
kept here; "what Prisma Composer should do about it" lives in the takeaways doc.
...
- `takeaways-for-prisma-composer.md`: what we want to emulate/adapt (expected to change)
