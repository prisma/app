...
// The app's own build (ADR-0005): the smoke service's runnable, built to a
// SINGLE self-contained dist/smoke/server.mjs. @prisma/compose/node's assemble()
...
export default defineConfig({
  entry: { server: 'src/smoke/server.ts' },
  outDir: 'dist/smoke',
  format: 'esm',
  platform: 'node',
